...
import { post, API_ORIGIN, apiHeaders } from "../lib/api";
...
export default function Attendance() {
  ...
  const exportCsv = async () => {
    const res = await fetch(`${API_ORIGIN}/api/attendance/export?month=${month}`, { credentials: "include", headers: apiHeaders({ Accept: "text/csv" }) });
    if (!res.ok) {
