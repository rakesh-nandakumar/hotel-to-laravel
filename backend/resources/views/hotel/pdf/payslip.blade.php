...
@endif
@if($line->deduction > 0)
    <x-pdf-row :left="'Deduction'.($line->deduction_note ? ' ('.$line->deduction_note.')' : '')" :right="'-'.\App\Support\Money::format($line->deduction)" />
@endif
<hr class="hr">
...
<div style="margin-top:8px; font-size:8px; color:#666">
    Employer contributions (not deducted from pay): EPF {{ \App\Support\Money::format($line->epf_employer) }} · ETF {{ \App\Support\Money::format($line->etf) }}
</div>
