...
class SettingsSeeder extends Seeder
{
    ...
    public static function definitions(): array
    {
        return [
            ...
            ['key' => 'hotel.timezone', 'value' => 'Asia/Colombo', 'type' => SettingType::TEXT, 'category' => 'hotel', 'label' => 'Timezone', 'hint' => 'Applied to the tenant\'s whole request pipeline — dates and times render in this zone.'],
            ['key' => 'hotel.locale', 'value' => 'en', 'type' => SettingType::TEXT, 'category' => 'hotel', 'label' => 'Locale / Language'],
            ['key' => 'hotel.currency_code', 'value' => 'LKR', 'type' => SettingType::TEXT, 'category' => 'hotel', 'label' => 'Currency Code'],
            ['key' => 'hotel.currency_symbol', 'value' => 'Rs.', 'type' => SettingType::TEXT, 'category' => 'hotel', 'label' => 'Currency Symbol'],
