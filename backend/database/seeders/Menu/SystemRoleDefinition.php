        ...
        return [
            ...
            'Manager' => [
                ...
                'permissions' => [
                    ...
                    'hotel_rooms' => ['access', 'create', 'edit', 'edit_status', 'delete'],
                    'hotel_packages' => ['access', 'edit'],
                    'hotel_guests' => ['access', 'view', 'create', 'edit', 'loyalty_adjust'],
                    'hotel_corporate' => ['access', 'create', 'edit'],
                    'hotel_reservations' => ['access', 'view', 'create', 'edit', 'check_in', 'checkout', 'cancel', 'discount'],
                    ...
                    'hotel_products' => ['access', 'create', 'edit', 'delete', 'adjust_stock'],
                    'hotel_grn' => ['access', 'view', 'create', 'edit', 'delete', 'receive'],
                    ...
                    'hotel_dining_tables' => ['access', 'create', 'edit', 'edit_status', 'delete'],
            ...
            'Chef' => [
                ...
                'permissions' => [
                    ...
                    'hotel_products' => ['access', 'create', 'edit', 'adjust_stock'],
                    'hotel_grn' => ['access', 'view', 'create', 'edit', 'receive'],
